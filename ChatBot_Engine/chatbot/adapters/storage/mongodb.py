from chatbot.adapters.storage import StorageAdapter
from chatbot.adapters.exceptions import EmptyDatabaseException
from chatbot.conversation import Statement, Response
from pymongo import MongoClient


class MongoDatabaseAdapter(StorageAdapter):
    """
    The MongoDatabaseAdapter is an interface that allows chatbot
